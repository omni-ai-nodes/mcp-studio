...
${ARTIFACT_INSTRUCTIONS_HEAD}
    - HTML: "text/html"
      ...
      - do not forget to add AI information in the footer: "Generated with [DeepChat](https://github.com/ThinkInAIXYZ/mcpchat) | All page content is AI-generated and for reference only" ,ensure it matches the page language
${ARTIFACT_INSTRUCTIONS_TAIL}
<example>
...
<body>
    ...
    <footer>
      Generated with <a href="https://github.com/ThinkInAIXYZ/mcpchat">DeepChat</a> | All page content is AI-generated and for reference only
    </footer>
</body>
</html>
    </antArtifact>
